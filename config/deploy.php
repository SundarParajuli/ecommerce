...
return [
    ...
    */
    ...
    'options' => [
        'application' => env('APP_NAME', 'Raramart UAT'),
        'repository' => 'git@gitlab.com:bidhee/raramart-new.git',
    ],
    ...
    */
    ...
    'hosts' => [
        'raramart.bidheellc.com' => [
            'deploy_path' => '/mnt/added-volume-sgp/html/raramart-new',
            'user' => 'movie-user',
            'stage' => 'development',
        ],
    ],
