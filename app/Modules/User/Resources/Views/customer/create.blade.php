    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-body">
            <div class="panel-body">
                {!! Form::open(['route' => 'customer.store','method'=>'POST','class'=>'form-horizontal','user'=>'form','files' => true]) !!}
                <fieldset>
                    ...
                    <div class="form-group">
                        {!! Form::label('username','Customername',['class'=>'col-lg-3 control-label required_label']) !!}
                        <div class="col-lg-9">
                            {!! Form::text('username', $value = null, ['id'=>'username','class'=>'form-control','placeholder'=>'Customername']) !!}
