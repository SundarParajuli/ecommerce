...
@section('title') Create Staff Details @endsection
@section('breadcrumb')
    <li><a href="{{route('staff.index')}}">Districts</a></li>
            ...
            <div class="col-lg-12">
                <div class="panel panel-flat shadow-z-2">
                    <div class="panel-heading">
                        ...
                        <h5 class="panel-title">Create Staff Details</h5>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                {!! Form::open(['route' => 'staff.store','method'=>'POST','class'=>'form-horizontal','role'=>'form']) !!}
